...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AreneX Techworks builds custom websites and web applications for startups and businesses in Pakistan. No templates. Fast, professional, built to convert. Get a proposal in 48 hours." },
      ...
      { name: "twitter:description", content: "AreneX Techworks builds custom websites and web applications for startups and businesses in Pakistan. No templates. Fast, professional, built to convert. Get a proposal in 48 hours." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/D0YDhj5i7GNb9Pz4LZbZYP9EE7w2/social-images/social-1782390097397-38700.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/D0YDhj5i7GNb9Pz4LZbZYP9EE7w2/social-images/social-1782390097397-38700.webp" },
    ],
    links: [
